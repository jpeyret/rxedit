...
- As much as possible, user error in entering commands and command flags will be ignored and will result in
  ...
  -  Use the `explain` command to get feedback on what it understood or not.

  -  Risk: If you display lots of lines, then want to use `less` to hide some before editing what's left
