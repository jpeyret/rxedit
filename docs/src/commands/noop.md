...
- [`explain`](./explain.md) will try to tell why you ended up with No-operation.

- If the only command present is a No-operation, rxedit will ask you to specify at least one valid 
command.  

- Be careful when you are using rxedit to modify a file with [`change`](./change.md) or [`delete`](./delete.md).  A preceding
